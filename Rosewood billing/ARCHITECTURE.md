...
| Refund | Evidence of an already completed refund, limited to confirmed unapplied fee money or held bond money. It never calls a payment provider. |
...
| Billing batch | Staff-reviewed selection of students, fee lines, dates and cohort. Preview is a priced snapshot; commit creates drafts once. Issuing remains a deliberate step. |
