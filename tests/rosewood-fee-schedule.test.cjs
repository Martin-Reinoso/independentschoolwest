...
assert.match(calculator, /Any applicable sibling, bond and annual-payment discounts are then calculated on the remaining tuition/);
assert.doesNotMatch(calculator, /compound|multiply rather than add/i);
assert.doesNotMatch(calculatorV2, /compound|multiply rather than add/i);
