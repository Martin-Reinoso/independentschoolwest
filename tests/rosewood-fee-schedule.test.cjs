...
assert.match(schedule, /They compound - or multiply - rather than being added together/);
assert.match(schedule, /\(\$6,990 − \$1,000\)[\s\S]+85%[\s\S]+95%[\s\S]+95%/);
assert.match(schedule, /\$5,505\.08/);
