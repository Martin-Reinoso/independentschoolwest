...
export class GoogleDriveStore {
  ...
  async createUploadSession({ applicationId, category, fileName, mimeType, size }) {
    const metadata = { name: `${applicationId}-${category}-${safeName(fileName)}`, parents: [this.applicationFolderId], appProperties: { rosewoodWorkflow: "application", rosewoodApplicationId: applicationId, rosewoodCategory: category, rosewoodExpectedMime: mimeType, rosewoodExpectedSize: String(size) } };
