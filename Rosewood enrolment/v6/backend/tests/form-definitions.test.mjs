...
test("V12 keeps V10 and V11 addressable while preserving both data contracts", () => {
  ...
  assert.equal(current.formVersion, "rosewood-application-2026.12");
  ...
  assert.equal(currentEoi.formVersion, "rosewood-eoi-2026.12");
