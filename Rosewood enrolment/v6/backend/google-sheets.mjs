...
const headers = {
  eoi: {
    "EOIs": ["eoi_id", "submitted_at", "status", "primary_contact_id", "student_id", "language", "salutation", "primary_contact_first_name", "primary_contact_last_name", "relationship", "email", "mobile_phone", "contact_address", "suburb", "state", "postcode", "country", "student_first_name", "student_last_name", "date_of_birth", "gender", "religion", "entry_year", "entry_year_level", "current_school", "current_year_level", "additional_needs", "need_categories", "family_connection", "other_children", "discovery_source", "additional_information", "snapshot_file_id", "network_fingerprint", "schema_version", "reference", "form_version", "form_definition_hash"],
    "EOI Audit": ["event_id", "occurred_at", "eoi_id", "event_type", "actor_type", "actor_id", "details_json", "schema_version"]
  },
  application: {
    "Applications": ["application_id", "invitation_id", "source_eoi_id", "status", "reference", "recipient_email", "student_id", "student_first_name", "student_last_name", "created_at", "updated_at", "submitted_at", "completed_at", "revision", "required_signature_count", "completed_signature_count", "snapshot_file_id", "schema_version", "form_version", "form_definition_hash", "requires_staff_review", "one_signature_explanation", "signature_control_revision"],
    "Student": ["application_id", "student_id", "first_name", "middle_name", "last_name", "preferred_name", "date_of_birth", "gender", "religion", "religion_other", "current_year_level", "entry_year", "entry_year_level", "current_school", "current_school_other", "share_address_with_guardians", "care_arrangement", "care_arrangement_other", "shared_parenting_schedule", "address", "suburb", "state", "postcode", "country", "future_siblings", "future_sibling_count", "country_of_residence", "country_of_birth", "nationality", "ethnicity", "arrival_or_return_date", "residency_status", "australian_citizen", "residency_evidence", "visa_subclass", "visa_expiry", "previous_visa_subclass", "indigenous_status", "main_language", "other_languages", "additional_needs", "need_categories", "need_other", "health_professionals", "health_professional_other", "reports_attached", "ndis_support", "court_or_parenting_orders", "other_relevant_information", "parish", "sacraments_json", "medical_conditions", "other_medical_condition", "condition_details", "allergy_details", "anaphylaxis_risk", "anaphylaxis_device", "immunisation_status", "humanitarian_health_check", "doctor_name", "doctor_practice_address", "doctor_phone", "medicare_number", "medicare_expiry", "private_health_insurance", "ambulance_cover", "health_care_card", "schema_version", "form_version", "form_definition_hash", "previous_school_attended", "previous_school_name", "previous_school_year_level", "interrupted_schooling", "interrupted_schooling_details", "formal_assessment", "formal_assessment_details", "formal_assessment_report_available", "current_adjustments", "rosewood_adjustments", "medicare_reference_number", "private_health_insurance_provider", "private_health_insurance_policy_number", "health_care_card_number", "health_care_card_expiry"],
    "Guardians": ["application_id", "guardian_id", "position", "share_with_other_contacts", "salutation", "first_name", "last_name", "email", "mobile_phone", "home_phone", "work_phone", "relationship", "contact_type", "marital_status", "religion", "sms_messaging", "health_care_card", "health_care_card_number", "health_care_card_expiry", "residential_address", "suburb", "state", "postcode", "country", "postal_same_as_residential", "postal_address", "postal_suburb", "postal_state", "postal_postcode", "postal_country", "occupational_group", "occupation", "employer", "school_level_education", "university_further_education", "country_of_birth", "nationality", "ethnicity", "languages", "residency_status", "visa_subclass", "visa_expiry", "indigenous_status", "contact_permission", "signature_required", "signature_status", "schema_version", "form_version", "form_definition_hash", "application_contact_email", "previous_email_history_json", "email_corrected_at", "email_correction_requested_by", "signature_request_generated", "signature_request_sent", "signature_request_status", "signature_request_sent_at", "signature_request_opened_at", "signing_email_verified_at", "signed_document_revision", "previous_link_revoked_at", "requires_staff_review", "contact_permission_changed_at", "contact_permission_changed_by", "signature_request_delivery_status", "signature_request_delivery_at"],
    "Emergency Contacts": ["application_id", "emergency_contact_id", "position", "first_name", "last_name", "relationship", "mobile_phone", "home_phone", "work_phone", "email", "schema_version", "form_version", "form_definition_hash"],
    "Documents": ["application_id", "document_id", "category", "original_file_name", "mime_type", "size_bytes", "drive_file_id", "uploaded_at", "sha256", "malware_scan_status", "schema_version", "storage_provider", "storage_key", "storage_version_id", "form_version", "form_definition_hash"],
    "Conditions": ["application_id", "previous_school_permission", "previous_school_name", "previous_school_address", "previous_school_interstate", "fee_option", "fee_account_recipient", "guardian_a_name", "guardian_a_percentage", "guardian_b_name", "guardian_b_percentage", "fee_responsibility_date", "discovery_source", "influence_factors", "schema_version", "form_version", "form_definition_hash", "previous_school_attended", "previous_school_year_level", "student_commitments_accepted", "parent_carer_commitments_accepted", "parent_carer_agreement_acknowledged", "special_aptitudes", "preferred_subjects", "subjects_needing_help", "hobbies_cultural_pursuits", "sport_participation", "extracurricular_activities", "local_library", "school_attractions", "desired_personal_qualities", "mentoring_value", "intended_years"],
    "Signatures": ["application_id", "signature_id", "guardian_id", "signer_name", "signer_email", "signature_status", "signed_at", "revision", "revision_hash", "signature_file_id", "network_fingerprint", "ip_recording_acknowledged", "application_terms_acknowledged", "one_signature_explanation", "additional_information", "schema_version", "form_version", "form_definition_hash"],
