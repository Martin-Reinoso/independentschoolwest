...
const headers = {
  ...
  application: {
    ...
    "Conditions": ["application_id", "previous_school_permission", "previous_school_name", "previous_school_address", "previous_school_interstate", "fee_option", "fee_account_recipient", "guardian_a_name", "guardian_a_percentage", "guardian_b_name", "guardian_b_percentage", "fee_responsibility_date", "discovery_source", "influence_factors", "schema_version", "form_version", "form_definition_hash"],
