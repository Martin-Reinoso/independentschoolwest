...
const headers = {
  ...
  application: {
    "Applications": ["application_id", "invitation_id", "source_eoi_id", "status", "reference", "recipient_email", "student_id", "student_first_name", "student_last_name", "created_at", "updated_at", "submitted_at", "completed_at", "revision", "required_signature_count", "completed_signature_count", "snapshot_file_id", "schema_version", "form_version", "form_definition_hash"],
