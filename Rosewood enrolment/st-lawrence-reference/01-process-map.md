...
| 25D | Review agreement before remote signature | Additional guardian | Details save succeeds | Complete agreement is rendered read-only; a reviewed-and-ready checkbox gates Sign | SLB-019 | Captured; confirmation remains unchecked |
| 25E | Complete additional acceptance signature | Additional guardian | Review confirmation succeeds | Sign and Thank You stages, completion outcome and final notices | SLB-EMAIL-017, SLB-EMAIL-018 | Interface and current completion copy to capture; historical emails evidence the pattern |
