(() => {
  ...
  async function openTask(initial=null) { context=initial||(preview?{studentName:"Ava Example",revision:4,policyVersion:"draft-2026-08-02",signer:{firstName:"Morgan",lastName:"Example",email:"guardian@example.test",mobile:"0400 000 000",relationship:"Parent"}}:await api("/v2/signatures/context"));prefill();document.getElementById("sign-access-view").hidden=true;document.getElementById("sign-application-view").hidden=false;setStage(0); }
