...
(function () {
  ...
  const SUPPORTED_APPLICATION_FORM_VERSIONS = new Set(["rosewood-application-2026.1", "rosewood-application-2026.2", "rosewood-application-2026.3", "rosewood-application-2026.4", "rosewood-application-2026.5", "rosewood-application-2026.6", "rosewood-application-2026.7", "rosewood-application-2026.8", "rosewood-application-2026.9", "rosewood-application-2026.10", "rosewood-application-2026.11", "rosewood-application-2026.12", "rosewood-application-2026.13", "rosewood-application-2026.14", "rosewood-application-2026.15", "rosewood-application-2026.16", "rosewood-application-2026.17", "rosewood-application-2026.18", "rosewood-application-2026.19", "rosewood-application-2026.20", "rosewood-application-2026.21", "rosewood-application-2026.22", "rosewood-application-2026.23", "rosewood-application-2026.24", "rosewood-application-2026.25", "rosewood-application-2026.26", "rosewood-application-2026.27", "rosewood-application-2026.28", "rosewood-application-2026.29"]);
  ...
  function showServiceError(error) {
    ...
    const action = first ? `<li class="validation-summary-action"><button type="button" class="button button-secondary" data-validation-screen="${first.screen}" data-validation-field="${esc(first.field)}">Review ${esc(first.section)}</button></li>` : "";
  ...
  function missingAnswerGuidance(code) {
    ...
    const exact = {
      ...
      future_siblings: { section: "Student – Family", screen: 3, message: "Please select Yes or No for “Do you have any other children who may apply?”" },
      future_sibling_count: { section: "Student – Family", screen: 3, message: "Please enter how many other children may apply." },
      "future_sibling_count:invalid": { section: "Student – Family", screen: 3, message: "Please enter a whole number from 1 to 99 for how many other children may apply." },
  ...
  function renderApplicationStudent() {
    return intro("Student", "Provide the student, residence, family, background, support, sacramental and medical information requested in the application.", "Application for enrolment") +
      ...
      section("Family", `${choices("future_siblings", "Do you have any other children, apart from this child, who may apply to Rosewood College in the future?", yesNo, { required: true, className: "family-question", hint: "Do not include the child named in this application." })}<div class="conditional-panel" data-conditional="future-siblings"><div class="field-grid two">${field("future_sibling_count", "How many other children may apply?", { type: "number", min: 1, max: 99, required: true })}</div></div>`) +
  ...
  function showInlineServerValidation({ focus = false, field = "" } = {}) {
    ...
    current.forEach(item => {
      ...
      if (item.field === field) requestedControl = control || wrapper;
    });
    const focusControl = requestedControl || firstControl;
    if (focus && focusControl) {
      focusControl.scrollIntoView({ block: "center", behavior: "smooth" });
  ...
  errorSummary.addEventListener("click", async event => {
    ...
    updateConditionals();
    showInlineServerValidation({ focus: true, field: action.dataset.validationField || "" });
  });
